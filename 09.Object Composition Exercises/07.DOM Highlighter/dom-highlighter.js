function traverseDom(selector){
    ...
    heightFromBottomToTargetNode(maxDepth, deepestNode)

    function heightFromBottomToTargetNode(remainingNodes, currentNode){
        if(remainingNodes === -1){
            return
        }
        currentNode.addClass('highlight')
        let parent = currentNode.parent()
        heightFromBottomToTargetNode(remainingNodes - 1, $(parent))
    }
